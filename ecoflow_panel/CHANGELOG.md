...
- Tests: +5 (`predictiveAuditFixes.test.ts` — forecast-runtime gate present/suppressed/no-forecast; string-mismatch leave-one-out 2× and single-peer-null). Full server suite 666/666; web build clean.
