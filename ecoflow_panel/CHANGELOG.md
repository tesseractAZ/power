...
- Tests: +6 (`predictiveAuditFixes.test.ts` — forecast-runtime gate present/suppressed/no-forecast + cache-keys-on-depletion-verdict regression; string-mismatch leave-one-out 2× and single-peer-null). Full server suite 667/667; web build clean.
