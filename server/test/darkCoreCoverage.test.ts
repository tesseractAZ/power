...
test('★ v1.153.0, CORRECTED in v1.163.0 — no sampling bound and no unconditional ANALYZE on the boot path', () => {
  ...
  // evaluation.
  // v1.163.0 CORRECTION: this test used to pin `PRAGMA analysis_limit=400` ahead of
