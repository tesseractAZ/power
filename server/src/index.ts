...
app.get('/api/dispatch/recommend', async (req, reply) => {
  ...
  // Tariff: Eric's APS plan is flat $0.17/kWh (no TOU). Default both peak
 ...
 *
 * v0.9.41 diagnosed Eric's tts.piper entity as empty (no voice metadata
 ...
 * on connect — assuming Eric has saved a voice in Piper add-on config.
 */
