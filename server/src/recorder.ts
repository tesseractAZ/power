...
export function createRecorder(
  ...
  //
  // v1.163.0 CORRECTION — THE BOUND NEVER BOUNDED THE BOOT. v1.153.0 set
  ...
  // The page-count mechanism above is the evidence. CHANGELOG 1.163.0 also records a
  // pair of Pi boot timings, but they are cold-vs-warm and prove less than they look.
  //
