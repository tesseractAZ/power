...
export async function getDayForecast(
  ...
  // diagnostic models below (Eric still wants spare-array visibility
...
// v0.9.58 — default to a FLAT rate (Eric's APS plan is flat $0.17/kWh — no TOU
...
export async function computeProbabilisticForecast(
  ...
  // kWh/pack. Eric's ~4 DPUs × 5 × 6.144 ≈ 122.88 kWh — the prior code's
...
export async function computeMultiDayForecast(
  ...
  // total day load came out to ~19 kWh — vs Eric's real 30-90 kWh daily
...
// imperfections. 10% of Eric's 16.8 kW array → σ ≈ 1 680 W → σ² ≈ 2.82e6.
