...
/**
     ...
     * SPDX-License-Identifier: BSD-3-Clause
     */
const pe={attribute:!0,type:String,converter:b,reflect:!1,hasChanged:w},ue=(e=pe,t,s)=>{const{kind:o,metadata:i}=s;let r=globalThis.litPropertyMetadata.get(i);if(void 0===r&&globalThis.litPropertyMetadata.set(i,r=new Map),"setter"===o&&((e=Object.create(e)).wrapped=!0),r.set(s.name,e),"accessor"===o){const{name:o}=s;return{set(s){const i=t.get.call(this);t.set.call(this,s),this.requestUpdate(o,i,e,!0,s)},init(t){return void 0!==t&&this.C(o,void 0,e,t),t}}}if("setter"===o){const{name:o}=s;return function(s){const i=this[o];t.call(this,s),this.requestUpdate(o,i,e,!0,s)}}throw Error("Unsupported decorator location: "+o)};
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */function fe(e){return(t,s)=>"object"==typeof s?ue(e,t,s):((e,t,s)=>{const o=t.hasOwnProperty(s);return t.constructor.createProperty(s,e),o?Object.getOwnPropertyDescriptor(t,s):void 0})(e,t,s)}
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */function ge(e){return fe({...e,state:!0,attribute:!1})}const me=new Map,ve=[1e3,2e3,4e3,8e3,16e3,3e4];function ye(e,t={}){const s=t.wsCtor??("undefined"!=typeof WebSocket?WebSocket:void 0),o=t.fetchImpl??("undefined"!=typeof fetch?fetch:void 0);let i=null,r="idle",a=null,n=0,l=null,c=null,d=!1,h=!1;const p=new Set,u=()=>{for(const e of p)try{e(i)}catch(e){"undefined"!=typeof console&&console.warn("[ecoflow] snapshot subscriber threw",e)}},f=e=>{r!==e&&(r=e,u())},g=()=>{null!=l&&(clearTimeout(l),l=null)},m=()=>{null!=c&&(clearTimeout(c),c=null)},v=()=>{if(g(),a){a.onopen=null,a.onmessage=null,a.onerror=null,a.onclose=null;try{a.close()}catch{}a=null}},y=()=>{if(d||!s)return;let t;g(),f("idle"===r?"connecting":"reconnecting");try{t=new s(function(e){let t=e.trim().replace(/\/$/,"");return/^https?:\/\//i.test(t)?t=t.replace(/^http/i,"ws"):/^wss?:\/\//i.test(t)||(t=`ws://${t}`),`${t}/ws`}(e))}catch{return void $()}a=t,t.onopen=()=>{d||a!==t||(n=0,f("open"),(()=>{if(h||!o)return;h=!0;const t=function(e,t){let s=e.trim().replace(/\/$/,"");return/^wss?:\/\//i.test(s)?s=s.replace(/^ws/i,"http"):/^https?:\/\//i.test(s)||(s=`http://${s}`),`${s}${t.startsWith("/")?t:`/${t}`}`}(e,"/api/snapshot");o(t).then(e=>e.ok?e.json():null).then(e=>{!d&&e&&null==i&&(i=e,u())}).catch(()=>{})})())},t.onmessage=e=>{if(!d&&a===t)try{const t=JSON.parse("string"==typeof e.data?e.data:"");t&&"snapshot"===t.type&&t.data&&(i=t.data,u())}catch{}},t.onerror=()=>{},t.onclose=()=>{a===t&&(a=null,d?f("closed"):$())}},$=()=>{if(d)return;f("reconnecting");const e=Math.min(n,ve.length-1);n+=1,l=setTimeout(()=>{l=null,y()},ve[e])},b={getSnapshot:()=>i,connectionState:()=>r,subscribe(t){m(),p.add(t);try{t(i)}catch(e){"undefined"!=typeof console&&console.warn("[ecoflow] snapshot subscriber threw",e)}return 1===p.size&&null==a&&"open"!==r&&"connecting"!==r&&"reconnecting"!==r&&y(),()=>{p.delete(t)&&0===p.size&&(m(),c=setTimeout(()=>{c=null,0===p.size&&(v(),n=0,h=!1,f("idle"),me.get(e)===b&&me.delete(e))},5e3))}},_destroy(){d=!0,m(),v(),f("closed"),p.clear(),me.get(e)===b&&me.delete(e)}};return b}class $e extends de{constructor(){super(...arguments),this.snapshot=null,this.connState="idle",this._unsubscribe=null,this._stateTimer=null}setConfig(e){if(!e)throw new Error("Invalid config");this.config={host:e.host||"http://homeassistant.local:8787",title:e.title||"EcoFlow Panel",refresh_seconds:e.refresh_seconds??30,type:e.type}}effectiveHost(){return this.config?.host||"http://homeassistant.local:8787"}connectedCallback(){super.connectedCallback();const e=function(e){const t=me.get(e);if(t)return t;const s=ye(e);return me.set(e,s),s}(this.effectiveHost());this.connState=e.connectionState(),this._unsubscribe=e.subscribe(t=>{this.snapshot=t,this.connState=e.connectionState()})}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe&&this._unsubscribe(),this._unsubscribe=null,this._stateTimer&&(clearInterval(this._stateTimer),this._stateTimer=null)}getCardSize(){return 6}}t([fe({attribute:!1})],$e.prototype,"config",void 0),t([ge()],$e.prototype,"snapshot",void 0),t([ge()],$e.prototype,"connState",void 0);const be=n`
  :host {
...
`;function we(e){const t=e.match(/(\d+)\s*$/);return t?Number(t[1]):null}function xe(e,t){const s=e=>{const t=(e.productName??"").toLowerCase();return t.includes("smart home panel")?0:t.includes("delta pro ultra")?1:t.includes("delta 3 plus")?2:3},o=s(e),i=s(t);if(o!==i)return o-i;if(1===o){const s=we(e.deviceName),o=we(t.deviceName);if(null!=s&&null!=o)return s-o;if(null!=s)return-1;if(null!=o)return 1}return e.deviceName.localeCompare(t.deviceName)}const ke=e=>null==e?"—":Math.abs(e)>=1e3?`${(e/1e3).toFixed(2)} kW`:`${Math.round(e)} W`,_e={};function Ae(e,t){for(const s of e.split("|"))_e[s.trim()]=t}function Se(e){const t=function(e){const t=function(e){return e.split("·")[0].split("(")[0].replace(/\s+/g," ").trim().toLowerCase()}(e);return t?_e[t]:void 0}(e);return t?B`<span class="ef-glossary"
    >${e}<span class="ef-tooltip" role="tooltip">${t}</span></span
  >`:e}function Pe(e,t,s,o){const i=t-e||1,r=o-s;return t=>s+(t-e)/i*r}function Ee(e,t,s){const o=[];let i=!1;for(const r of e){if(null==r.value||!Number.isFinite(r.value)){i=!1;continue}const e=t(r.ts),a=s(r.value);o.push(`${i?"L":"M"} ${e.toFixed(1)} ${a.toFixed(1)}`),i=!0}return o.join(" ")}function Ce(e,t={}){const s=t.width??720,o=t.height??220,i=36,r=10,a=s-i-36,n=o-r-22,l=[...e.area?.points??[],...e.line?.points??[],...e.rightLine?.points??[]];if(l.length<2)return B`<div style="height:${o}px;color:var(--ef-muted);font-size:11px;display:flex;align-items:center;justify-content:center;">no forecast data</div>`;const c=l.map(e=>e.ts),d=Math.min(...c),h=Math.max(...c),p=[];e.area&&p.push(...e.area.points.map(e=>e.value).filter(e=>null!=e)),e.line&&p.push(...e.line.points.map(e=>e.value).filter(e=>null!=e));const u=t.yMax??1.05*Math.max(100,...p),f=Math.min(0,...p),g=Pe(d,h,i,i+a),m=Pe(f,u,r+n,r),v=Pe(0,100,r+n,r),y=m(0),$=216e5,b=[];for(let e=Math.ceil(d/$)*$;e<=h;e+=$){const t=g(e);b.push(q`<line x1=${t} x2=${t} y1=${r} y2=${r+n} stroke="var(--ef-line)" stroke-dasharray="2 3" stroke-opacity=".6" />`)}const w=[0,u/2,u].map(e=>({v:e,y:m(e)})),x=[0,50,100].map(e=>({v:e,y:v(e)})),k=e.area?function(e,t,s,o){const i=Ee(e,t,s);if(!i)return"";let r=null,a=null;for(const s of e)if(null!=s.value&&Number.isFinite(s.value)){const e=t(s.ts);null==r&&(r=e),a=e}return null==r||null==a?"":`${i} L ${a.toFixed(1)} ${o.toFixed(1)} L ${r.toFixed(1)} ${o.toFixed(1)} Z`}(e.area.points,g,m,y):"",_=e.line?Ee(e.line.points,g,m):"",A=e.rightLine?Ee(e.rightLine.points,g,v):"",S=e.rightRef?v(e.rightRef.value):null,P="display:inline-block;width:14px;height:2px;margin-right:4px;vertical-align:middle",E=B`<div style="display:flex;flex-wrap:wrap;gap:10px;font-size:11px;color:var(--ef-muted);margin-top:4px;">${e.area?.label?B`<span><span style="${"display:inline-block;width:10px;height:10px;opacity:.6;border-radius:2px;margin-right:4px"};background:${e.area.color};"></span>${e.area.label}</span>`:null}${e.line?.label?B`<span><span style="${P};background:${e.line.color};"></span>${e.line.label}</span>`:null}${e.rightLine?.label?B`<span><span style="${P};background:${e.rightLine.color};"></span>${e.rightLine.label}</span>`:null}</div>`;return B`<svg viewBox="0 0 ${s} ${o}" width="100%" height=${o} preserveAspectRatio="none" aria-hidden="true">${b}${w.map(e=>q`<line x1=${i} x2=${i+a} y1=${e.y} y2=${e.y} stroke="var(--ef-line)" stroke-opacity=".4" /><text x=${32} y=${e.y+3} text-anchor="end" font-size="9" fill="var(--ef-muted)">${(e.v/1e3).toFixed(1)}k</text>`)}${x.map(e=>q`<text x=${i+a+4} y=${e.y+3} text-anchor="start" font-size="9" fill="var(--ef-muted)">${e.v.toFixed(0)}%</text>`)}${null!=S?q`<line x1=${i} x2=${i+a} y1=${S} y2=${S} stroke=${e.rightRef.color} stroke-dasharray="4 4" stroke-opacity=".7" />`:null}${k?q`<path d=${k} fill=${e.area.color} fill-opacity=".35" stroke="none" />`:null}${_?q`<path d=${_} fill="none" stroke=${e.line.color} stroke-width="1.6" />`:null}${A?q`<path d=${A} fill="none" stroke=${e.rightLine.color} stroke-width="2" />`:null}</svg>${E}`}Ae("soc|state of charge","State of charge — how full the battery is right now, 0–100%."),Ae("avg soc","Average state of charge across every online battery pack in the fleet."),Ae("soh|state of health|avg soh","State of health — measured usable capacity vs the pack’s original design capacity. A wear gauge; 100% = like-new."),Ae("ocv|open-circuit","Open-circuit voltage — the pack’s resting voltage with no load applied."),Ae("cell spread|worst cell spread|cell imbalance|cell spread now","Cell-voltage spread — the gap between the highest and lowest cell in a pack. A widening gap is an early sign of imbalance."),Ae("cell mean","Average voltage across all of the pack’s cells."),Ae("pack volt","Pack terminal voltage."),Ae("rep temp","Representative pack temperature reported by the BMS."),Ae("cell max|cell min","Hottest / coldest individual cell temperature in the pack."),Ae("cell temperatures","Per-cell temperature sensors inside the pack."),Ae("cell voltages","Per-cell voltage, each shown with its deviation from the pack mean."),Ae("mos max|mosfet temperatures|mosfet temps|mosfet","Power-MOSFET temperature — the BMS switching transistors."),Ae("board","BMS circuit-board temperature."),Ae("shunt","Current-shunt temperature — the precision resistor the BMS measures pack current across."),Ae("ptc heater temperatures|ptc heater temps|ptc","PTC heater temperature — keeps the cells warm enough to charge safely in the cold."),Ae("cycles","Equivalent full charge/discharge cycles the pack has completed — a measure of battery age."),Ae("lifetime throughput","Total energy ever charged into and discharged out of the pack."),Ae("capacity","Energy the battery can store, in kWh."),Ae("balancing|cells balancing","The BMS is equalizing cell voltages — routine housekeeping, no action needed."),Ae("hottest pack","The warmest pack across the fleet right now."),Ae("vitals","The pack’s key live readings at a glance."),Ae("pv|pv in|pv total|photovoltaic","Photovoltaic — solar-panel power."),Ae("pv high mppt|pv low mppt","Power from one of the DPU’s two solar strings (high- or low-voltage MPPT input)."),Ae("ac out|ac output","AC power flowing out of the inverter to your loads."),Ae("ac in","AC power flowing into the inverter — grid or generator charging."),Ae("ac out freq / v","Inverter AC output frequency (Hz) and voltage."),Ae("total in / out","Total power into and out of the DPU across every input and output."),Ae("battery v / a","Internal battery-bus voltage and current."),Ae("in|out","Power flowing in to / out of the device."),Ae("input|output","Power flowing into (charging) or out of (discharging) the pack."),Ae("panel load","Total power the SHP2’s circuits are drawing right now."),Ae("live contribution|live draw","Power this device is feeding/drawing right now."),Ae("voltage|current","Live electrical voltage / current at this input."),Ae("v × a","Voltage × current — instantaneous power, shown as a cross-check on the reported watts."),Ae("string ω","Effective resistance (volts ÷ amps) at the MPPT string’s operating point."),Ae("mppt|mppt temp|mppt hv|mppt lv|hv mppt|lv mppt","MPPT — the solar charge controller (Maximum Power Point Tracker). Each DPU has two: a high-voltage and a low-voltage string input."),Ae("hv channels|lv channels","High-/low-voltage MPPT solar string inputs — one of each per DPU."),Ae("ghi","Global Horizontal Irradiance — total sunlight energy on a flat surface (W/m²); the raw “how sunny” number the forecast is built from."),Ae("producing now","Solar power being generated right now."),Ae("peak today","The highest solar power reached so far today."),Ae("coefficient|peak response|response coefficient","Learned response coefficient — watts of PV produced per W/m² of sunlight. Captures panel size, orientation, shading and inverter clipping."),Ae("strongest hour","The hour of day your arrays convert sunlight to power most efficiently — reveals their orientation."),Ae("observed peak pv","The highest PV output actually recorded at this hour-of-day."),Ae("soiling","Dust/pollen on the panels cutting output. Detected by comparing clear-sky production to the cleanest day on record."),Ae("output drop","How far clear-sky solar output has fallen below the clean-panel baseline — the soiling indicator."),Ae("backup|backup pool","SHP2 backup pool — the combined battery the Smart Home Panel draws on."),Ae("backup %","Backup-pool state of charge, trended over the last hour."),Ae("reserve floor|backup reserve|reserve","Reserve floor — the state of charge held back for backup. Loads begin shedding below it."),Ae("solar reserve","Target state of charge to keep in reserve specifically when running on solar."),Ae("mid-priority floor","The SoC at which mid-priority circuits are cut to protect the battery."),Ae("charge power","Power currently flowing into the battery."),Ae("charge time","Estimated time to fully charge the battery."),Ae("rated power","The device’s rated maximum power output."),Ae("ems bat temp","Battery temperature as reported by the SHP2’s energy-management system."),Ae("hw link","Hardware (wired) link status between the SHP2 and this DPU."),Ae("load-shed strategy","The SHP2’s automatic plan for dropping circuits as the battery depletes."),Ae("smart backup mode","The SHP2’s backup-behaviour mode setting."),Ae("charge schedule","The SHP2’s time-of-use scheduled charging windows."),Ae("error code|direct errors|shp2 errors","Device-reported error code — 0 means no fault."),Ae("charging power","Power the EV charger is drawing, over the last 24 hours."),Ae("sessions today","Charging sessions detected today — a sustained draw above 1 kW."),Ae("host dpu|dpu battery","The Delta Pro Ultra the EV charger is wired to — that DPU’s AC output equals the charging draw."),Ae("direct telemetry|direct evse telemetry","Raw data straight from the device over MQTT, rather than inferred."),Ae("solar next 24 h|solar next 24h","Projected solar production, from the cloud forecast run through your learned array model."),Ae("forecast load|forecast load 24 h|typical solar / day","Projected household load from the typical-day consumption curve."),Ae("forecast pv","Projected PV output for this hour."),Ae("projected low soc","The lowest the battery is forecast to reach over the next 24 hours."),Ae("cloud cover","Forecast cloud cover — what derates the solar prediction each hour."),Ae("outlook","At-a-glance battery comfort vs the reserve floor: Comfortable, Watch or Tight."),Ae("history depth","Days of recorded data behind the forecast and learned models — they sharpen as it grows."),Ae("confidence","How trustworthy the learned model is, based on how many samples it has."),Ae("z-score|peer z-score","Modified z-score — how many robust deviations a reading sits from normal. Higher = more anomalous; ≥ 3.5 flags, ≥ 5 warns."),Ae("fit quality|fit r²","R-squared — how well the trend line fits the data, 0–1. Higher means a more trustworthy projection."),Ae("samples|regression samples","How many data points the estimate is built from — more points, more reliable."),Ae("sibling median","The median reading across the pack’s four siblings — the “normal” this pack is compared against."),Ae("this pack","This pack’s current reading."),Ae("deviation","How far this reading sits from the expected/normal value."),Ae("baseline window","The span of history and number of samples behind the self-baseline."),Ae("decline rate|rise rate","How fast the value is changing, per unit time."),Ae("end-of-life|eol|projected eol|reaches 80%","End of life — the 80%-SoH point where a pack has lost a fifth of its original capacity; the conventional LFP replacement mark."),Ae("fade rate|fade / yr|avg fade rate","How fast measured capacity (State of Health) is falling — SoH percentage points lost per year."),Ae("service left|years left|years to eol","Projected years of service remaining before the pack reaches the 80% end-of-life threshold."),Ae("eol threshold","The State of Health at which a pack counts as end-of-life — conventionally 80% for LFP cells."),Ae("packs projecting","How many packs have a firm enough SoH trend to project an end-of-life date."),Ae("soonest eol","The pack across the fleet projected to reach end-of-life first."),Ae("cycles at eol","Projected equivalent full-cycle count by the time the pack reaches end-of-life."),Ae("data span","Days of recorded history the projection is regressed over."),Ae("projection notes","Plain-language end-of-life verdict for each pack with a firm fade trend."),Ae("trend","Whether a pack has a projected fade trend, is stable, is still learning, or has no data yet."),Ae("critical","Critical — an immediate problem that needs attention now."),Ae("warnings|warning","Warning — something to investigate soon."),Ae("informational|info","Informational — noted for awareness, not urgent."),Ae("anomalies","Things unusual right now — flagged by peer comparison and self-baseline."),Ae("forecasts","Where things are heading — runtime, degradation and day-ahead projections."),Ae("actionable","Critical + warning items that may need attention."),Ae("recently cleared","Alerts that were raised and have since resolved, with how long each lasted."),Ae("today","Energy totals since local midnight."),Ae("solar produced","Total solar energy harvested today."),Ae("batteries","Net battery energy today — negative means net charged, positive means net discharged.");class Te extends de{constructor(){super(...arguments),this.tone="neutral"}render(){return B`<slot></slot>`}}Te.styles=[be,n`
      :host {
        display: inline-flex;
        align-items: center;
        font-size: 0.75rem;
    ...
    `],t([fe({reflect:!0})],Te.prototype,"tone",void 0),customElements.get("ef-badge")||customElements.define("ef-badge",Te);class He extends de{constructor(){super(...arguments),this.label="",this.value="",this.unit=""}render(){return B`
    ...
    `],t([fe()],He.prototype,"label",void 0),t([fe()],He.prototype,"value",void 0),t([fe()],He.prototype,"unit",void 0),customElements.get("ef-tile")||customElements.define("ef-tile",He);class Me extends de{constructor(){super(...arguments),this.title=""}render(){return B`
      <header>
    ...
    `],t([fe()],Me.prototype,"title",void 0),customElements.get("ef-section")||customElements.define("ef-section",Me);e.EcoflowSolarCard=class extends $e{constructor(){super(...arguments),this.today={data:null,stale:!1},this.forecast={data:null,stale:!1},this.prob={data:null,stale:!1},this.clipping={data:null,stale:!1},this.soiling={data:null,stale:!1},this.shade={data:null,stale:!1},this._fastTimer=null,this._slowTimer=null}connectedCallback(){super.connectedCallback(),this._kickFast(),this._kickSlow();const e=Math.max(10,this.config?.refresh_seconds??30),t=Math.max(e,60);this._fastTimer=setInterval(()=>this._kickFast(),1e3*e),this._slowTimer=setInterval(()=>this._kickSlow(),1e3*t)}disconnectedCallback(){super.disconnectedCallback(),this._fastTimer&&(clearInterval(this._fastTimer),this._fastTimer=null),this._slowTimer&&(clearInterval(this._slowTimer),this._slowTimer=null)}_kickFast(){this._fetchOne("/api/summary/today",()=>this.today,e=>this.today=e),this._fetchOne("/api/forecast",()=>this.forecast,e=>this.forecast=e),this._fetchOne("/api/forecast/probabilistic",()=>this.prob,e=>this.prob=e)}_kickSlow(){this._fetchOne("/api/clipping",()=>this.clipping,e=>this.clipping=e),this._fetchOne("/api/soiling-decomposition",()=>this.soiling,e=>this.soiling=e),this._fetchOne("/api/shade-report",()=>this.shade,e=>this.shade=e)}async _fetchOne(e,t,s){try{const t=this.effectiveHost().replace(/\/$/,"")+e,o=await fetch(t);if(!o.ok)throw new Error(`HTTP ${o.status}`);s({data:await o.json(),stale:!1})}catch{s({...t(),stale:!0})}}connTone(e){return"open"===e?"ok":"connecting"===e||"reconnecting"===e?"warn":"closed"===e?"bad":"neutral"}connLabel(e){return"open"===e?"live":"connecting"===e?"linking":"reconnecting"===e?"reconnecting":"closed"===e?"offline":"idle"}dpuList(){const e=this.snapshot;if(!e)return[];var t;return(t=Object.values(e.devices),[...t].sort(xe)).filter(e=>"dpu"===e.projection?.kind&&e.online)}wiredArraySns(){const e=this.snapshot;if(!e)return new Set;const t=Object.values(e.devices).find(e=>"shp2"===e.projection?.kind);return t?new Set(t.projection.sources.map(e=>e.sn).filter(e=>!!e)):new Set}render(){const e=this.snapshot,t=this.config?.title??"Solar";if(!e)return B`<ha-card>
      ...
      <div class="full">
        <div class="top-row">
          <ef-tile label="Now" value=${ke(t)} unit="">
            <span>HV ${ke(s)} · LV ${ke(o)}</span>
          </ef-tile>
      ...
      <div class="full">
        <div class="mppt-table">
          <div class="mppt-head">${Se("mppt")} string</div>
          ...
          ${s.map(e=>{const t=(e=>0!==(e.errCode??0)?{klass:"bad",sym:"!",title:`error code ${e.errCode}`}:e.arrayed?(e.watts??0)>5?{klass:"ok",sym:"✓",title:"producing"}:{klass:"idle",sym:"·",title:"idle (no sun / no array)"}:{klass:"idle",sym:"—",title:"no array wired"})(e);return B`
              ...
              <div class="mppt-cell mppt-num">${ke(e.watts)}</div>
      ...
      </ef-section>`;let o,i=Z;if(t&&t.hours.length>0){o=this.renderProbForecastChart(t);const e=t.uncertaintyKwhStdev,s=t.pAboveReservePct;i=B`<ef-badge slot="header" tone=${null!=s&&s<70?"warn":"ok"}
        >±${e.toFixed(1)} kWh · ${null!=s?`${s}% above reserve`:"no SoC ref"}</ef-badge
      >`}else{const t=e.hours.map(e=>({ts:e.ts,value:e.forecastPvW}));o=Ce({area:{points:t,color:"#d97706",label:"Forecast PV (P50)"}},{height:200})}return B`<ef-section .title=${"24-hour forecast"}>
      <ef-badge slot="header" tone=${e.hasWeather?"ok":"neutral"}
        >${e.hasWeather?"cloud-aware":"history only"}</ef-badge
      >
      ${i}
      ...
      </div>`;const t=e.perHour.filter(e=>e.clippedW>5).length,s=e.todayKwh,o=s>.2?B`<strong>${s.toFixed(1)} kWh</strong> clipped today over ${t} hour${1===t?"":"s"}`:B`<strong>0 kWh</strong> clipped today — array peak ${ke(e.arrayPeakW)}`,i=s>.2?`Inverter capped output at peak (~${ke(e.arrayPeakW)}); more arrays or batteries could absorb the surplus.`:"Inverter is keeping up with peak production — no power lost to clipping.";return B`<div class="diag-row">
      ...
      <div class="diag-text">
        ${Se("soiling")}: <strong>${t.dropPct.toFixed(0)}% ${Se("output drop")}</strong>
      ...
      <div class="diag-text">
        Shade: <strong>${t.shortfallPct.toFixed(0)}% shortfall</strong> at ${s(t.hour)}<br /><span
          class="muted"
          >Around ${s(t.hour)} the array produces ${ke(t.observedW)} vs ${ke(t.expectedW)} clear-sky.${o>0?` Est. ~${o.toFixed(0)} kWh/year lost.`:""}</span
        >
      </div>
    </div>`}},e.EcoflowSolarCard.styles=[be,n`
      :host {
        display: block;
      }
      ha-card {
    ...
    `],t([ge()],e.EcoflowSolarCard.prototype,"today",void 0),t([ge()],e.EcoflowSolarCard.prototype,"forecast",void 0),t([ge()],e.EcoflowSolarCard.prototype,"prob",void 0),t([ge()],e.EcoflowSolarCard.prototype,"clipping",void 0),t([ge()],e.EcoflowSolarCard.prototype,"soiling",void 0),t([ge()],e.EcoflowSolarCard.prototype,"shade",void 0),e.EcoflowSolarCard=t([(e=>(t,s)=>{void 0!==s?s.addInitializer(()=>{customElements.define(e,t)}):customElements.define(e,t)})("ecoflow-solar-card")],e.EcoflowSolarCard);const je=window;return je.customCards=je.customCards||[],je.customCards.some(e=>"ecoflow-solar-card"===e.type)||je.customCards.push({type:"ecoflow-solar-card",name:"EcoFlow Solar Card",description:"Live PV + per-MPPT detail + day-ahead forecast + diagnostics"}),e}({});
