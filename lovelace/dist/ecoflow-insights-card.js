...
/**
     ...
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */function fe(e){return ue({...e,state:!0,attribute:!1})}const ve=new Map,ge=[1e3,2e3,4e3,8e3,16e3,3e4];function me(e,t={}){const s=t.wsCtor??("undefined"!=typeof WebSocket?WebSocket:void 0),i=t.fetchImpl??("undefined"!=typeof fetch?fetch:void 0);let r=null,a="idle",n=null,o=0,l=null,c=null,d=!1,h=!1;const p=new Set,u=()=>{for(const e of p)try{e(r)}catch(e){"undefined"!=typeof console&&console.warn("[ecoflow] snapshot subscriber threw",e)}},f=e=>{a!==e&&(a=e,u())},v=()=>{null!=l&&(clearTimeout(l),l=null)},g=()=>{null!=c&&(clearTimeout(c),c=null)},m=()=>{if(v(),n){n.onopen=null,n.onmessage=null,n.onerror=null,n.onclose=null;try{n.close()}catch{}n=null}},b=()=>{if(d||!s)return;let t;v(),f("idle"===a?"connecting":"reconnecting");try{t=new s(function(e){let t=e.trim().replace(/\/$/,"");return/^https?:\/\//i.test(t)?t=t.replace(/^http/i,"ws"):/^wss?:\/\//i.test(t)||(t=`ws://${t}`),`${t}/ws`}(e))}catch{return void w()}n=t,t.onopen=()=>{d||n!==t||(o=0,f("open"),(()=>{if(h||!i)return;h=!0;const t=function(e,t){let s=e.trim().replace(/\/$/,"");return/^wss?:\/\//i.test(s)?s=s.replace(/^ws/i,"http"):/^https?:\/\//i.test(s)||(s=`http://${s}`),`${s}${t.startsWith("/")?t:`/${t}`}`}(e,"/api/snapshot");i(t).then(e=>e.ok?e.json():null).then(e=>{!d&&e&&null==r&&(r=e,u())}).catch(()=>{})})())},t.onmessage=e=>{if(!d&&n===t)try{const t=JSON.parse("string"==typeof e.data?e.data:"");t&&"snapshot"===t.type&&t.data&&(r=t.data,u())}catch{}},t.onerror=()=>{},t.onclose=()=>{n===t&&(n=null,d?f("closed"):w())}},w=()=>{if(d)return;f("reconnecting");const e=Math.min(o,ge.length-1);o+=1,l=setTimeout(()=>{l=null,b()},ge[e])},$={getSnapshot:()=>r,connectionState:()=>a,subscribe(t){g(),p.add(t);try{t(r)}catch(e){"undefined"!=typeof console&&console.warn("[ecoflow] snapshot subscriber threw",e)}return 1===p.size&&null==n&&"open"!==a&&"connecting"!==a&&"reconnecting"!==a&&b(),()=>{p.delete(t)&&0===p.size&&(g(),c=setTimeout(()=>{c=null,0===p.size&&(m(),o=0,h=!1,f("idle"),ve.get(e)===$&&ve.delete(e))},5e3))}},_destroy(){d=!0,g(),m(),f("closed"),p.clear(),ve.get(e)===$&&ve.delete(e)}};return $}class be extends le{constructor(){super(...arguments),this.snapshot=null,this.connState="idle",this._unsubscribe=null,this._stateTimer=null}setConfig(e){if(!e)throw new Error("Invalid config");this.config={host:e.host||"http://homeassistant.local:8787",title:e.title||"EcoFlow Panel",refresh_seconds:e.refresh_seconds??30,type:e.type}}effectiveHost(){return this.config?.host||"http://homeassistant.local:8787"}connectedCallback(){super.connectedCallback();const e=function(e){const t=ve.get(e);if(t)return t;const s=me(e);return ve.set(e,s),s}(this.effectiveHost());this.connState=e.connectionState(),this._unsubscribe=e.subscribe(t=>{this.snapshot=t,this.connState=e.connectionState()})}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe&&this._unsubscribe(),this._unsubscribe=null,this._stateTimer&&(clearInterval(this._stateTimer),this._stateTimer=null)}getCardSize(){return 6}}t([ue({attribute:!1})],be.prototype,"config",void 0),t([fe()],be.prototype,"snapshot",void 0),t([fe()],be.prototype,"connState",void 0);const we=o`
  :host {
...
`,$e={};function ye(e,t){for(const s of e.split("|"))$e[s.trim()]=t}function xe(e){const t=function(e){const t=function(e){return e.split("·")[0].split("(")[0].replace(/\s+/g," ").trim().toLowerCase()}(e);return t?$e[t]:void 0}(e);return t?q`<span class="ef-glossary"
    >${e}<span class="ef-tooltip" role="tooltip">${t}</span></span
  >`:e}function _e(e,t,s,i){const r=t-e||1,a=i-s;return t=>s+(t-e)/r*a}function ke(e,t={}){const s=t.width??320,i=t.height??40,r=t.color??"var(--ef-accent)",a=e.map(e=>e.value).filter(e=>null!=e&&Number.isFinite(e));if(a.length<2)return q`<div style="height:${i}px;color:var(--ef-muted);font-size:10px;">collecting…</div>`;const n=Math.min(...a),o=Math.max(...a),l=.05*(o-n)||1,c=t.yMin??n-l,d=t.yMax??o+l,h=function(e,t,s){const i=[];let r=!1;for(const a of e){if(null==a.value||!Number.isFinite(a.value)){r=!1;continue}const e=t(a.ts),n=s(a.value);i.push(`${r?"L":"M"} ${e.toFixed(1)} ${n.toFixed(1)}`),r=!0}return i.join(" ")}(e,_e(e[0].ts,e[e.length-1].ts,2,s-2),_e(c,d,i-2,2));return q`
  ...
  `}ye("soc|state of charge","State of charge — how full the battery is right now, 0–100%."),ye("avg soc","Average state of charge across every online battery pack in the fleet."),ye("soh|state of health|avg soh","State of health — measured usable capacity vs the pack’s original design capacity. A wear gauge; 100% = like-new."),ye("ocv|open-circuit","Open-circuit voltage — the pack’s resting voltage with no load applied."),ye("cell spread|worst cell spread|cell imbalance|cell spread now","Cell-voltage spread — the gap between the highest and lowest cell in a pack. A widening gap is an early sign of imbalance."),ye("cell mean","Average voltage across all of the pack’s cells."),ye("pack volt","Pack terminal voltage."),ye("rep temp","Representative pack temperature reported by the BMS."),ye("cell max|cell min","Hottest / coldest individual cell temperature in the pack."),ye("cell temperatures","Per-cell temperature sensors inside the pack."),ye("cell voltages","Per-cell voltage, each shown with its deviation from the pack mean."),ye("mos max|mosfet temperatures|mosfet temps|mosfet","Power-MOSFET temperature — the BMS switching transistors."),ye("board","BMS circuit-board temperature."),ye("shunt","Current-shunt temperature — the precision resistor the BMS measures pack current across."),ye("ptc heater temperatures|ptc heater temps|ptc","PTC heater temperature — keeps the cells warm enough to charge safely in the cold."),ye("cycles","Equivalent full charge/discharge cycles the pack has completed — a measure of battery age."),ye("lifetime throughput","Total energy ever charged into and discharged out of the pack."),ye("capacity","Energy the battery can store, in kWh."),ye("balancing|cells balancing","The BMS is equalizing cell voltages — routine housekeeping, no action needed."),ye("hottest pack","The warmest pack across the fleet right now."),ye("vitals","The pack’s key live readings at a glance."),ye("pv|pv in|pv total|photovoltaic","Photovoltaic — solar-panel power."),ye("pv high mppt|pv low mppt","Power from one of the DPU’s two solar strings (high- or low-voltage MPPT input)."),ye("ac out|ac output","AC power flowing out of the inverter to your loads."),ye("ac in","AC power flowing into the inverter — grid or generator charging."),ye("ac out freq / v","Inverter AC output frequency (Hz) and voltage."),ye("total in / out","Total power into and out of the DPU across every input and output."),ye("battery v / a","Internal battery-bus voltage and current."),ye("in|out","Power flowing in to / out of the device."),ye("input|output","Power flowing into (charging) or out of (discharging) the pack."),ye("panel load","Total power the SHP2’s circuits are drawing right now."),ye("live contribution|live draw","Power this device is feeding/drawing right now."),ye("voltage|current","Live electrical voltage / current at this input."),ye("v × a","Voltage × current — instantaneous power, shown as a cross-check on the reported watts."),ye("string ω","Effective resistance (volts ÷ amps) at the MPPT string’s operating point."),ye("mppt|mppt temp|mppt hv|mppt lv|hv mppt|lv mppt","MPPT — the solar charge controller (Maximum Power Point Tracker). Each DPU has two: a high-voltage and a low-voltage string input."),ye("hv channels|lv channels","High-/low-voltage MPPT solar string inputs — one of each per DPU."),ye("ghi","Global Horizontal Irradiance — total sunlight energy on a flat surface (W/m²); the raw “how sunny” number the forecast is built from."),ye("producing now","Solar power being generated right now."),ye("peak today","The highest solar power reached so far today."),ye("coefficient|peak response|response coefficient","Learned response coefficient — watts of PV produced per W/m² of sunlight. Captures panel size, orientation, shading and inverter clipping."),ye("strongest hour","The hour of day your arrays convert sunlight to power most efficiently — reveals their orientation."),ye("observed peak pv","The highest PV output actually recorded at this hour-of-day."),ye("soiling","Dust/pollen on the panels cutting output. Detected by comparing clear-sky production to the cleanest day on record."),ye("output drop","How far clear-sky solar output has fallen below the clean-panel baseline — the soiling indicator."),ye("backup|backup pool","SHP2 backup pool — the combined battery the Smart Home Panel draws on."),ye("backup %","Backup-pool state of charge, trended over the last hour."),ye("reserve floor|backup reserve|reserve","Reserve floor — the state of charge held back for backup. Loads begin shedding below it."),ye("solar reserve","Target state of charge to keep in reserve specifically when running on solar."),ye("mid-priority floor","The SoC at which mid-priority circuits are cut to protect the battery."),ye("charge power","Power currently flowing into the battery."),ye("charge time","Estimated time to fully charge the battery."),ye("rated power","The device’s rated maximum power output."),ye("ems bat temp","Battery temperature as reported by the SHP2’s energy-management system."),ye("hw link","Hardware (wired) link status between the SHP2 and this DPU."),ye("load-shed strategy","The SHP2’s automatic plan for dropping circuits as the battery depletes."),ye("smart backup mode","The SHP2’s backup-behaviour mode setting."),ye("charge schedule","The SHP2’s time-of-use scheduled charging windows."),ye("error code|direct errors|shp2 errors","Device-reported error code — 0 means no fault."),ye("charging power","Power the EV charger is drawing, over the last 24 hours."),ye("sessions today","Charging sessions detected today — a sustained draw above 1 kW."),ye("host dpu|dpu battery","The Delta Pro Ultra the EV charger is wired to — that DPU’s AC output equals the charging draw."),ye("direct telemetry|direct evse telemetry","Raw data straight from the device over MQTT, rather than inferred."),ye("solar next 24 h|solar next 24h","Projected solar production, from the cloud forecast run through your learned array model."),ye("forecast load|forecast load 24 h|typical solar / day","Projected household load from the typical-day consumption curve."),ye("forecast pv","Projected PV output for this hour."),ye("projected low soc","The lowest the battery is forecast to reach over the next 24 hours."),ye("cloud cover","Forecast cloud cover — what derates the solar prediction each hour."),ye("outlook","At-a-glance battery comfort vs the reserve floor: Comfortable, Watch or Tight."),ye("history depth","Days of recorded data behind the forecast and learned models — they sharpen as it grows."),ye("confidence","How trustworthy the learned model is, based on how many samples it has."),ye("z-score|peer z-score","Modified z-score — how many robust deviations a reading sits from normal. Higher = more anomalous; ≥ 3.5 flags, ≥ 5 warns."),ye("fit quality|fit r²","R-squared — how well the trend line fits the data, 0–1. Higher means a more trustworthy projection."),ye("samples|regression samples","How many data points the estimate is built from — more points, more reliable."),ye("sibling median","The median reading across the pack’s four siblings — the “normal” this pack is compared against."),ye("this pack","This pack’s current reading."),ye("deviation","How far this reading sits from the expected/normal value."),ye("baseline window","The span of history and number of samples behind the self-baseline."),ye("decline rate|rise rate","How fast the value is changing, per unit time."),ye("end-of-life|eol|projected eol|reaches 80%","End of life — the 80%-SoH point where a pack has lost a fifth of its original capacity; the conventional LFP replacement mark."),ye("fade rate|fade / yr|avg fade rate","How fast measured capacity (State of Health) is falling — SoH percentage points lost per year."),ye("service left|years left|years to eol","Projected years of service remaining before the pack reaches the 80% end-of-life threshold."),ye("eol threshold","The State of Health at which a pack counts as end-of-life — conventionally 80% for LFP cells."),ye("packs projecting","How many packs have a firm enough SoH trend to project an end-of-life date."),ye("soonest eol","The pack across the fleet projected to reach end-of-life first."),ye("cycles at eol","Projected equivalent full-cycle count by the time the pack reaches end-of-life."),ye("data span","Days of recorded history the projection is regressed over."),ye("projection notes","Plain-language end-of-life verdict for each pack with a firm fade trend."),ye("trend","Whether a pack has a projected fade trend, is stable, is still learning, or has no data yet."),ye("critical","Critical — an immediate problem that needs attention now."),ye("warnings|warning","Warning — something to investigate soon."),ye("informational|info","Informational — noted for awareness, not urgent."),ye("anomalies","Things unusual right now — flagged by peer comparison and self-baseline."),ye("forecasts","Where things are heading — runtime, degradation and day-ahead projections."),ye("actionable","Critical + warning items that may need attention."),ye("recently cleared","Alerts that were raised and have since resolved, with how long each lasted."),ye("today","Energy totals since local midnight."),ye("solar produced","Total solar energy harvested today."),ye("batteries","Net battery energy today — negative means net charged, positive means net discharged.");let Se=class extends le{constructor(){super(...arguments),this.tone="neutral"}render(){return q`<slot></slot>`}};Se.styles=[we,o`
      :host {
        display: inline-flex;
        align-items: center;
        font-size: 0.75rem;
    ...
    `],t([ue({reflect:!0})],Se.prototype,"tone",void 0),Se=t([de("ef-badge")],Se);let Ae=class extends le{constructor(){super(...arguments),this.label="",this.value="",this.unit=""}render(){return q`
    ...
    `],t([ue()],Ae.prototype,"label",void 0),t([ue()],Ae.prototype,"value",void 0),t([ue()],Ae.prototype,"unit",void 0),Ae=t([de("ef-tile")],Ae);let Pe=class extends le{constructor(){super(...arguments),this.title=""}render(){return q`
      <header>
    ...
    `],t([ue()],Pe.prototype,"title",void 0),Pe=t([de("ef-section")],Pe);const Ee=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],Ce=["incidents","nws","selfConsumption"];e.EcoflowInsightsCard=class extends be{constructor(){super(...arguments),this.sc={data:null,stale:!1},this.thermal={data:null,stale:!1},this.equip={data:null,stale:!1},this.shade={data:null,stale:!1},this.soil={data:null,stale:!1},this.mismatch={data:null,stale:!1},this.ev={data:null,stale:!1},this.charge={data:null,stale:!1},this.ir={data:null,stale:!1},this.skill={data:null,stale:!1},this.ambient={data:null,stale:!1},this.conf={data:null,stale:!1},this.nws={data:null,stale:!1},this.incidents={data:null,stale:!1},this.ensemble={data:null,stale:!1},this.expanded=new Set(Ce),this._httpTimer=null}connectedCallback(){super.connectedCallback(),this._kickHttpFetches();const e=Math.max(15,this.config?.refresh_seconds??60);this._httpTimer=setInterval(()=>this._kickHttpFetches(),1e3*e)}disconnectedCallback(){super.disconnectedCallback(),this._httpTimer&&(clearInterval(this._httpTimer),this._httpTimer=null)}_kickHttpFetches(){this._fetchOne("/api/self-consumption",()=>this.sc,e=>this.sc=e),this._fetchOne("/api/thermal-events",()=>this.thermal,e=>this.thermal=e),this._fetchOne("/api/equipment-health",()=>this.equip,e=>this.equip=e),this._fetchOne("/api/shade-report",()=>this.shade,e=>this.shade=e),this._fetchOne("/api/soiling-decomposition",()=>this.soil,e=>this.soil=e),this._fetchOne("/api/string-mismatch",()=>this.mismatch,e=>this.mismatch=e),this._fetchOne("/api/ev-window-prediction",()=>this.ev,e=>this.ev=e),this._fetchOne("/api/charge-curve",()=>this.charge,e=>this.charge=e),this._fetchOne("/api/internal-resistance",()=>this.ir,e=>this.ir=e),this._fetchOne("/api/forecast-skill",()=>this.skill,e=>this.skill=e),this._fetchOne("/api/ambient-thermal-forecast",()=>this.ambient,e=>this.ambient=e),this._fetchOne("/api/confidence",()=>this.conf,e=>this.conf=e),this._fetchListEnvelope("/api/nws-alerts","alerts",()=>this.nws,e=>this.nws=e),this._fetchListEnvelope("/api/incidents","incidents",()=>this.incidents,e=>this.incidents=e),this._fetchEnsemble()}async _fetchOne(e,t,s){try{const t=this.effectiveHost().replace(/\/$/,"")+e,i=await fetch(t);if(!i.ok)throw new Error(`HTTP ${i.status}`);s({data:await i.json(),stale:!1})}catch{s({...t(),stale:!0})}}async _fetchListEnvelope(e,t,s,i){try{const s=this.effectiveHost().replace(/\/$/,"")+e,r=await fetch(s);if(!r.ok)throw new Error(`HTTP ${r.status}`);const a=await r.json();i({data:Array.isArray(a[t])?a[t]:[],stale:!1})}catch{i({...s(),stale:!0})}}async _fetchEnsemble(){try{const e=this.effectiveHost().replace(/\/$/,"")+"/api/weather/ensemble",t=await fetch(e);if(!t.ok)throw new Error(`HTTP ${t.status}`);const s=await t.json();if(s.error)return void(this.ensemble={data:null,stale:!1});this.ensemble={data:{sourcesCount:Number(s.sourcesCount??0),avgDisagreementPct:Number(s.avgDisagreementPct??0),enrichedHourCount:Number(s.enrichedHourCount??0),hourCount:Number(s.hourCount??0)},stale:!1}}catch{this.ensemble={...this.ensemble,stale:!0}}}connTone(e){return"open"===e?"ok":"connecting"===e||"reconnecting"===e?"warn":"closed"===e?"bad":"neutral"}connLabel(e){return"open"===e?"live":"connecting"===e?"linking":"reconnecting"===e?"reconnecting":"closed"===e?"offline":"idle"}toggle(e){const t=new Set(this.expanded);t.has(e)?t.delete(e):t.add(e),this.expanded=t}wrapSection(e,t,s,i,r=!1){const a=this.expanded.has(e);return q`<ef-section>
      ...
      <div class="badges">
        ...
        >
    ...
    </div>`}renderIncidents(){const e=this.incidents.data??[];return 0!==e.length||this.incidents.stale?this.wrapSection("incidents",xe("Incident"),e.length>0?q`<ef-badge slot="header" tone="bad">${e.length}</ef-badge>`:V,()=>0===e.length?q`<div class="no-data">No active incidents.</div>`:q`<div class="row-list full">
        ...
        </div>`,this.incidents.stale):V}renderNws(){const e=this.nws.data??[];return 0!==e.length||this.nws.stale?this.wrapSection("nws",xe("NWS storm"),e.length>0?q`<ef-badge slot="header" tone="warn">${e.length}</ef-badge>`:V,()=>0===e.length?q`<div class="no-data">No active NWS alerts.</div>`:q`<div class="row-list full">
        ...
        </div>`,this.nws.stale):V}renderSelfConsumption(){const e=this.sc.data;return e||this.sc.stale?this.wrapSection("selfConsumption",xe("Self-consumption"),V,()=>e?q`<div class="tile-grid">
        ...
        </div>`},this.ensemble.stale):V}renderConfidence(){const e=this.conf.data;return e||this.conf.stale?this.wrapSection("confidence",xe("Confidence"),V,()=>e?q`<div class="tile-grid">
          <ef-tile
            label="Degradation R²"
          ...
          ${s.length>0?q`<div class="sub-head">${xe("MPPT")} efficiency</div>
                <div class="row-list">
          ...
          <div class="row-list">
            ${e.patterns.slice(0,8).map(e=>q`<div class="row">
                <span class="label"
                  >${Ee[e.dayOfWeek]} @ ${e.startHour}:00</span
                >
                <span class="meta"
        ...
        </div>`},this.ir.stale):V}renderSkill(){const e=this.skill.data;return e&&0!==e.days.length||this.skill.stale?this.wrapSection("skill",xe("Forecast skill"),V,()=>{if(!e||0===e.days.length)return q`<div class="no-data">Forecast skill needs more days of hindcast.</div>`;const t=e.days.filter(e=>null!=e.errorPct).map(e=>({ts:new Date(e.date).getTime(),value:Math.abs(e.errorPct)}));return q`<div class="full">
          ...
          ${t.length>=2?q`<div class="full">
                ${ke(t,{width:320,height:36,color:"var(--ef-warn)"})}
              </div>`:V}
          <div class="tile-grid">
        ...
        </div>`},this.ambient.stale):V}getCardSize(){return 10}},e.EcoflowInsightsCard.styles=[we,o`
      :host { display: block; }
    ...
    `],t([fe()],e.EcoflowInsightsCard.prototype,"sc",void 0),t([fe()],e.EcoflowInsightsCard.prototype,"thermal",void 0),t([fe()],e.EcoflowInsightsCard.prototype,"equip",void 0),t([fe()],e.EcoflowInsightsCard.prototype,"shade",void 0),t([fe()],e.EcoflowInsightsCard.prototype,"soil",void 0),t([fe()],e.EcoflowInsightsCard.prototype,"mismatch",void 0),t([fe()],e.EcoflowInsightsCard.prototype,"ev",void 0),t([fe()],e.EcoflowInsightsCard.prototype,"charge",void 0),t([fe()],e.EcoflowInsightsCard.prototype,"ir",void 0),t([fe()],e.EcoflowInsightsCard.prototype,"skill",void 0),t([fe()],e.EcoflowInsightsCard.prototype,"ambient",void 0),t([fe()],e.EcoflowInsightsCard.prototype,"conf",void 0),t([fe()],e.EcoflowInsightsCard.prototype,"nws",void 0),t([fe()],e.EcoflowInsightsCard.prototype,"incidents",void 0),t([fe()],e.EcoflowInsightsCard.prototype,"ensemble",void 0),t([fe()],e.EcoflowInsightsCard.prototype,"expanded",void 0),e.EcoflowInsightsCard=t([de("ecoflow-insights-card")],e.EcoflowInsightsCard);const Te=window;return Te.customCards=Te.customCards||[],Te.customCards.some(e=>"ecoflow-insights-card"===e.type)||Te.customCards.push({type:"ecoflow-insights-card",name:"EcoFlow Advanced Insights",description:"v0.7.5 advanced analytics — incidents, NWS, self-consumption, equipment, etc."}),e}({});
